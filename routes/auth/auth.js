...
//middleware
import { validateAccessToken, userAlreadyExists, validateLoginData, validateForgotPasswordCode, validateRefreshToken, validatePassword, validateEmail, validateUsername, updatePassword } from '../../middleware/auth.js';
...
router.patch('/updatePassword', validateEmail, validateForgotPasswordCode, validatePassword, updatePassword, (req, res) => res.sendStatus(204));
